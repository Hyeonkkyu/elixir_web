      ...
      <section className='Books inner'>
        ...
        <div className='newRelease'>
          <div className='left'>
            ...
            <a href='http://www.yes24.com/Product/Goods/113795769' target="_blank" className="buyBtn">구매하기</a>
          </div>
          <div className='right'>
            <h3 className='tit'>인사이트 밀</h3>
            <p className='writer'>요네자와 호노부</p>
            <p className='sudDes'>요네자와 호노부의 본격 미스터리 성찬</p>
            <p className='des'>“다른 사람을 살해했을 경우,  다른 사람에게 살해되었을 경우,  다른 사람을 살해한 사람을 지목했을 경우,  다른 사람을 살해한 사람을 지목한 사람을 도왔을 경우,  여러분은 더욱 많은 보수를 받으실 수 있습니다.”<br />
